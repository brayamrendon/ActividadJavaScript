...
6 cuotas de $................. total $................. ( 40% de recargo)*/
 ...
 let value =prompt("Ingresa el valor del producto")
 let fee =prompt("Ingresa el numero de cuotas que vas a pagar ")
 let op1   =(parseInt(value)/2)
 let op2   =((op1*.05)+op1) 
 let op3   =(parseInt(value)/6)
 let op4   =((op3*.40)+op3)   

if (fee==1) {
    alert("1 Cuota de $ "+value+" 0% de recargo")
}else if (fee==2){
